...
public class NfcUtils {
    ...
    public static void NfcInit(Activity activity) {
        ...
        mTechList = new String[][]{
                ...
                {android.nfc.tech.NfcBarcode.class.getName()},
        };
        //生成intentFilter
        mIntentFilter = new IntentFilter[]{filter, new IntentFilter(NfcAdapter.ACTION_TAG_DISCOVERED), new IntentFilter(NfcAdapter.ACTION_TECH_DISCOVERED)};
    }
